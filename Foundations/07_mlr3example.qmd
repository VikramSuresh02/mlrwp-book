...
*This [article](https://institute-and-faculty-of-actuaries.github.io/mlr-blog/post/foundations/mlr3example/) was written by Grainne McGuire and Jacky Poon and originally published on 5 May 2021.*

*A python version (including a simple neural network) is available [here](https://institute-and-faculty-of-actuaries.github.io/mlr-blog/post/foundations/scikitexample/).*



## Introduction

In this chapter we look at applying different machine learning (ML) models to a data set.
...
A [notebook version of this article](https://institute-and-faculty-of-actuaries.github.io/mlr-blog/f_notebooks/ML modelling on triangles - a worked example.html) is also available which may be helpful if you want to experiment with this code. 
...
* Reserving with GLMs - see  @sec-glms-r
* Self-assembling claim reserving models using the LASSO - see @sec-lasso
...
One of our [previous chapters](#f-topten-r-packages) covers multi-model packages.  
...
Install this using the **remotes** package - the code is given below in the comments. If you're using **renv** to manage your packages, then use that instead.
...
Finally, we will use the LASSO to fit a model. We are going to fit the same model as we did in our previous [chapter](@f-lasso). We'll include a bare-bones description of the model here. If you haven't seen it before, then you may want to just take the model as given and skip ahead to the next section. Once you've read this entire article you may then wish to read the post on the LASSO model to understand the specifics of this model.
